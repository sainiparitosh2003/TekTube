...
import com.tektube.entity.Sequence;
...
public class Utilities {
	...
	public static Long getNextSequence(String key) throws TekTubeException {
		...
		if(seq == null)throw new TekTubeException("Unable to get sequence id for key" + key);
		return seq.getSeq();	
	}
